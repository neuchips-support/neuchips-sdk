...
def generate_requirements(platform):
    pattern = f"../../llama-cpp-python/*{platform}*.whl"
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python3 gen_neu_llama_cpp_python_requires.py <platform>")
        print("Example: python3 gen_neu_llama_cpp_python_requires.py linux")
        sys.exit(1)
